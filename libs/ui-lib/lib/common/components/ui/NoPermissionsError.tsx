...
import {
  t_temp_dev_tbd as iconColor /* CODEMODS: you should update this color token, original v5 token was global_disabled_color_100 */,
...
const NoPermissionsError = () => (
  <EmptyState id="not-found" icon={ExclamationTriangleIcon}>
    <EmptyStateBody>
      {/* <EmptyStateIcon icon={ExclamationTriangleIcon} color={iconColor.value} />  CODEMODS TODO: color the new way? */}
