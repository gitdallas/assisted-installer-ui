...
import { t_temp_dev_tbd as successColor /* CODEMODS: you should update this color token, original v5 token was global_success_color_100 */ } from "@patternfly/react-tokens/dist/js/t_temp_dev_tbd";
